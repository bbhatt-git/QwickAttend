...
export default function Footer() {
  return (
    <footer className="mt-auto border-t pt-2">
      <div className="container mx-auto flex flex-col items-center justify-between gap-2 pb-2 text-center text-sm text-muted-foreground sm:flex-row">
